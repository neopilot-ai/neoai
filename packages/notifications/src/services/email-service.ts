...
import { shouldSendNotification } from "@neoai/db/queries";
import InvoiceEmail from "@neoai/email/emails/invoice";
import InvoiceOverdueEmail from "@neoai/email/emails/invoice-overdue";
import InvoicePaidEmail from "@neoai/email/emails/invoice-paid";
import InvoiceReminderEmail from "@neoai/email/emails/invoice-reminder";
import TransactionsEmail from "@neoai/email/emails/transactions";
...
export class EmailService {
  ...
  #buildEmailPayload(email: EmailInput): CreateEmailOptions {
    ...
    const payload: CreateEmailOptions = {
      from: email.from || "Neoai <neoaibot@khulnasoft.com>",
      to: recipients,
