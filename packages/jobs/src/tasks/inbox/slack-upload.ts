import {
  ...
  downloadFile,
} from "@neoai/app-store/slack-client";
import { DocumentClient } from "@neoai/documents";
import { inboxSlackUploadSchema } from "@neoai/jobs/schema";
                ...
                elements: [
                  {
                    ...
                    url: `https://app.neoai.khulnasoft.com/inbox?id=${encodeURIComponent(updatedInbox.id)}`,
