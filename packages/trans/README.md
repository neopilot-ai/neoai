<p align="center">
  <img src="https://github.com/neopilot-ai/trans/blob/main/apps/web/src/app/%5Blocale%5D/opengraph-image.png" />
</p>
...
Trans helps developers to focus on building features, not wrestling with
...
## Made with 🤍 from Neoai

Trans was made from the implementation in [Neoai](https://neoai.khulnasoft.com), we
have now extracted it into a standalone CLI tool.

Neoai is a all in one tool for invoicing, Time tracking, File reconciliation,
...
for a commercial license at [engineer@khulnasoft.com](mailto:engineer@khulnasoft.com).
