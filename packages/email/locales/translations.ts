// @ts-nocheck - let's use https://www.npmjs.com/package/@neoai/trans-react-email
  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on Neoai`,
        "invite.preview": `Join ${params?.teamName} on Neoai`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på Neoai`,
        "invite.preview": `Gå med i ${params?.teamName} på Neoai`,
