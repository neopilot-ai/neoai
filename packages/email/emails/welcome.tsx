...
export const WelcomeEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Welcome to Neoai! I'm Pontus, one of the founders. It's really important to us that you have a great experience ramping up.`;
      ...
      >
        ...
        >
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Welcome to Neoai! I'm Pontus, one of the founders.
            <br />
            <br />
            We built Neoai from over 10 years of running our own businesses,
            knowing firsthand the challenges that come with it. Neoai is built
            together with our customers, and it's important to us that you know
            we're here when you need us.
            <br />
            <br />
            Take your time to explore Neoai at your own pace. If you ever want
            to chat with us founders, you can schedule a time{" "}
            <Link
              href="https://cal.com/pontus-neoai/15min"
