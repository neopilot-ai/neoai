...
export const TrialExpiringEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Just a quick reminder—your Neoai trial ends in 3 days. We hope you've had a great experience so far.`;
    ...
    <EmailThemeProvider preview={<Preview>{text}</Preview>}>
      ...
      >
        ...
        >
          ...
          >
            Your Neoai Trial is Expiring Soon
          </Heading>
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Just a quick reminder—your Neoai trial ends in 3 days. We hope
          ...
          <Section className="text-center mt-[50px] mb-[50px]">
            <Button href="https://app.neoai.khulnasoft.com/settings/billing">
              Claim your discount
            </Button>
          </Section>
          <Text
