export const expoReactNativeRules = [
  ...
  Naming Conventions
  - Use lowercase with dashes for mcpdata (e.g., components/auth-wizard).
  ...
  - Organize Files by Feature: Group related components, hooks, and styles into feature-based mcpdata (e.g., user-profile, chat-screen).

  Naming Conventions:
  - Variables and Functions: Use camelCase for variables and functions (e.g., isFetchingData, handleUserInput).
  - Components: Use PascalCase for component names (e.g., UserProfile, ChatScreen).
  - Mcpdata: Use lowercase and hyphenated names for mcpdata (e.g., user-profile, chat-screen).
