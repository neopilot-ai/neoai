...
export const updateTeamByIdSchema = z.object({
  ...
  logoUrl: z
    ...
    .refine((url) => url.includes("neoai.khulnasoft.com"), {
      message: "logoUrl must be a neoai.khulnasoft.com domain URL",
    })
    .optional()
    .openapi({
      description:
        "URL to the team's logo image. Must be hosted on neoai.khulnasoft.com domain",
      example: "https://cdn.neoai.khulnasoft.com/logos/acme-corp.png",
    }),
...
export const teamMemberResponseSchema = z.object({
  ...
  avatarUrl: z.string().url().nullable().openapi({
    ...
    example: "https://cdn.neoai.khulnasoft.com/avatars/john-doe.png",
  }),
});
