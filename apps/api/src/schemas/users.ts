...
export const updateUserSchema = z.object({
  ...
  avatarUrl: z
    .string()
    .url()
    .refine((url) => url.includes("neoai.khulnasoft.com"), {
      message: "avatarUrl must be a neoai.khulnasoft.com domain URL",
    })
    .optional()
    .openapi({
      description:
        "URL to the user's avatar image. Must be hosted on neoai.khulnasoft.com domain",
      example: "https://cdn.neoai.khulnasoft.com/avatars/jane-doe.jpg",
    }),
  ...
  team: z
    .object({
      ...
      logoUrl: z.string().url().openapi({
        ...
        example: "https://cdn.neoai.khulnasoft.com/logos/acme-corp.png",
      }),
