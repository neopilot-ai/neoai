...
import { getConnectionPoolStats } from "@neoai/db/client";
import { db } from "@neoai/db/client";
...
app.doc("/openapi", {
  ...
  info: {
    ...
    title: "Neoai API",
    description:
      "Neoai is a platform for Invoicing, Time tracking, File reconciliation, Storage, Financial Overview & your own Assistant.",
    contact: {
      name: "Neoai Support",
      email: "engineer@khulnasoft.com",
      url: "https://neoai.khulnasoft.com",
    },
    license: {
      name: "AGPL-3.0 license",
      url: "https://github.com/neoai-ai/neoai/blob/main/LICENSE",
    },
  },
  servers: [
    {
      url: "https://api.neoai.khulnasoft.com",
...
app.openAPIRegistry.registerComponent("securitySchemes", "token", {
  ...
  "x-speakeasy-example": "NEOAI_API_KEY",
});

app.get(
  "/",
  Scalar({ url: "/openapi", pageTitle: "Neoai API", theme: "saturn" }),
);
