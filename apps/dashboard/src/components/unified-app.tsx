...
import type { UnifiedApp } from "@neoai/app-store/types";
...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@neoai/ui/accordion";
import { Badge } from "@neoai/ui/badge";
import { Button } from "@neoai/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@neoai/ui/card";
import {
  Carousel,
  type CarouselApi,
  CarouselContent,
  CarouselItem,
} from "@neoai/ui/carousel";
import { ScrollArea } from "@neoai/ui/scroll-area";
            ...
            <div className="mt-4">
              ...
              <div className="absolute bottom-4 pt-8 border-t border-border">
                <p className="text-[10px] text-[#878787]">
                  All apps on the Neoai App Store are open-source and
                  peer-reviewed. Neoai Labs AB maintains high standards but
                  doesn't endorse third-party apps. Apps published by Neoai are
                  officially certified. Report any concerns about app content or
                  behavior.
                </p>

                <a
                  href="mailto:support@neoai.dev"
