import { createApp } from "@neoai/app-store/db";
import {
  config,
  createSlackApp,
  getSlackInstaller,
} from "@neoai/app-store/slack";
          ...
          blocks: [
            {
              ...
              text: {
                type: "mrkdwn",
                text: "Hello there! 👋 I'm your new Neoai bot, I'll send notifications in this channel regarding new transactions and other important updates.",
              },
            },
            {
              type: "divider",
            },
            {
              ...
              elements: [
                {
                  type: "mrkdwn",
                  text: "<https://app.neoai.khulnasoft.com/apps?app=slack&settings=true|Notification settings>",
                },
              ],
            },
          ],
