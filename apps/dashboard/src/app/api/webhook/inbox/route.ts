...
import { getAllowedAttachments } from "@neoai/documents";
import { LogEvents } from "@neoai/events/events";
import { setupAnalytics } from "@neoai/events/server";
import { getInboxIdFromEmail, inboxWebhookPostSchema } from "@neoai/inbox";
import type { ProcessAttachmentPayload } from "@neoai/jobs/schema";
import { createClient } from "@neoai/supabase/server";
import { getExtensionFromMimeType } from "@neoai/utils";
...
const FORWARD_FROM_EMAIL = "inbox@khulnasoft.com";
