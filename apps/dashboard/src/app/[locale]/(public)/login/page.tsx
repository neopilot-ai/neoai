...
import { isEU } from "@neoai/location";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
          ...
          <div className="relative z-10 flex h-full items-center justify-center p-6">
            <div className="w-full max-w-md space-y-8">
              ...
              <div className="text-center">
                <h1 className="text-lg mb-4 font-serif">Welcome to Neoai</h1>
              ...
              <div className="text-center absolute bottom-4 left-0 right-0">
                <p className="text-xs text-[#878787] leading-relaxed font-mono">
                  ...
                  <Link
                    href="https://neoai.khulnasoft.com/terms"
                    className="underline"
                  >
                    Terms of service
                  </Link>{" "}
                  &{" "}
                  <Link
                    href="https://neoai.khulnasoft.com/policy"
                    className="underline"
                  >
                    Privacy policy
                  </Link>
