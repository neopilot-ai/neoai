...
import { decrypt } from "@neoai/encryption";
import { HtmlTemplate } from "@neoai/invoice/templates/html";
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen dotted-bg p-4 sm:p-6 md:p-0">
      ...
      <div className="fixed bottom-4 right-4 hidden md:block">
        <a
          href="https://neoai.khulnasoft.com?utm_source=invoice"
          target="_blank"
          rel="noreferrer"
          className="text-[9px] text-[#878787]"
        >
          Powered by <span className="text-primary">neoai</span>
        </a>
      </div>
    </div>
  );
