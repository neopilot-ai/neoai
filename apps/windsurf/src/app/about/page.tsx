...
export default function About() {
  return (
    <div className="flex flex-col items-center justify-center max-w-screen-md mx-auto px-6 py-12">
      ...
      <div className="space-y-12 mt-10">
        <section>
          <p className="text-[#878787] leading-relaxed text-sm">
            ...
            <a
              href="https://go.neoai.khulnasoft.com/8cX3F4o"
            ...
            and{" "}
            <a
              href="https://go.neoai.khulnasoft.com/NnI1CUO"
              className="text-primary border-border border-dashed border-b-[1px]"
            >
              Languine
            </a>{" "}
        ...
        <section>
          ...
          <p className="text-[#878787] leading-relaxed text-sm">
            ...
            With Neoai, we're streamlining business operations, while with
        ...
        <section>
          ...
          <p className="text-[#878787] leading-relaxed text-sm">
            We're deeply committed to open source principles. Both Neoai and
        ...
        <section>
          ...
          <p className="text-[#878787] leading-relaxed text-sm">
            ...
            on X to stay updated with our latest developments on both Neoai and
            Languine.
          </p>
        </section>
      </div>
      ...
      <Image
        src="https://neoai.khulnasoft.com/cdn-cgi/image/width=1920,quality=80//_next/static/media/founders.c6158766.png"
        alt="Neoai founders"
        width={1920}
        height={1080}
