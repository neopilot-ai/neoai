...
const testimonials = [
  ...
  },
  {
    ...
    verified: true,
    quote:
      "nice to see @neoaiai generative ui features built on @vercel AI sdk neoai is becoming one of the best OSS @nextjs real-world apps",
  },
  {
    name: "Steven Tey",
    avatarUrl:
    ...
    handle: "@steventey",
    verified: true,
    quote: `Just found my new favorite open-source project → http://neoai.khulnasoft.com
  ...
  },
  {
    ...
    verified: true,
    quote:
      "the best thing i couldve done as a founder is build something that helps other founders. so proud 🖤 @neoaiai",
  },
];
