    ...
    <ul className="flex space-x-4 items-center md:ml-5">
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://go.neoai.khulnasoft.com/lS72Toq"
        >
      ...
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://go.neoai.khulnasoft.com/7rhA3rz"
        >
      ...
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://go.neoai.khulnasoft.com/anPiuRx"
        >
      ...
      <li>
        <a target="_blank" rel="noreferrer" href="https://git.new/neoai">
      ...
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://go.neoai.khulnasoft.com/Ct3xybK"
        >
      ...
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://go.neoai.khulnasoft.com/0yq8rfn"
        >
