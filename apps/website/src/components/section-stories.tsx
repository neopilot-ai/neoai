...
import { Avatar } from "@neoai/ui/avatar";
import { AvatarImageNext } from "@neoai/ui/avatar";
...
const stories = [
  {
    ...
    content: [
      ...
      },
      {
        type: "question",
        content:
          "What specific challenges were you facing in managing your business operations before using Neoai?",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "question",
        content:
          "How has Neoai impacted your workflow or productivity since you started using it? Can you share specific examples or metrics?",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "question",
        content:
          "What features or aspects of Neoai AI do you find most valuable, and why?",
      },
      {
        type: "paragraph",
        content:
  ...
  {
    id: 2,
    title: "“Without Neoai I would’ve sold my company and lost loads of money”",
    name: "Guy Solan",
    ...
    content: [
      {
        type: "paragraph",
        content:
          "”Without Neoai I would’ve sold my company and lost loads of money. I never had the time to learn Quickbooks or Xero so had no idea what the company cash was doing without ringing up my accountant.”",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Neoai helped me find a compromise with my tax advisor: I'm not using one of his supported clunky tools but an actually UX-friendly tool and can provide him with acceptable .csv. That's a big one!",
    ...
    content: [
      ...
      },
      {
        type: "paragraph",
        content:
          "Moreover, I moved from the invoicing feature of my business bank to Neoai. Not really a big challenge, but Neoai makes that just a bit easier (and I prefer to have one tool for finances, similar to what Deel is for HR).",
      },
      {
        type: "question",
        content:
  ...
  return (
    <div className="w-full h-[280px] relative">
      <ReactHlsPlayer
        ...
        onClick={togglePlay}
        autoPlay={false}
        poster="https://cdn.neoai.khulnasoft.com/guy-cover.png"
        playerRef={playerRef}
        className="w-full"
      />
