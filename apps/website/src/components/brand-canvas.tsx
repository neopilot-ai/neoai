...
export function BrandCanvas() {
  const [value, setValue] = useState(
    "https://cdn.neoai.khulnasoft.com/all.zip",
  );
      ...
      <div className="fixed bottom-10 z-20 w-full flex justify-center items-center -ml-[80px]">
        <div className="h-[48px] w-[200px] rounded-full border border-border backdrop-filter backdrop-blur-xl dark:bg-[#121212] bg-white bg-opacity-70 text-center flex items-center p-1 pl-2 justify-between space-x-4">
          <Select onValueChange={setValue} value={value}>
            ...
            <SelectContent>
              <SelectGroup>
                <SelectItem value="https://cdn.neoai.khulnasoft.com/all.zip">
                  All
                </SelectItem>
                <SelectItem value="https://cdn.neoai.khulnasoft.com/videos.zip">
                  Videos
                </SelectItem>
                <SelectItem value="https://cdn.neoai.khulnasoft.com/founders.zip">
                  Founders
                </SelectItem>
                <SelectItem value="https://cdn.neoai.khulnasoft.com/screens.zip">
                  Screens
                </SelectItem>
              </SelectGroup>
            </SelectContent>
