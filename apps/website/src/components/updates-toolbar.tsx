...
export function UpdatesToolbar({ posts }) {
  ...
  const handleOnShare = () => {
    const popup = popupCenter({
      url: `https://twitter.com/intent/tweet?text=${currentPost.title} https://neoai.khulnasoft.com/updates/${currentPost.slug}`,
      ...
      <DialogContent className="sm:max-w-[425px]">
        <div className="p-6">
          ...
          <div className="grid gap-6 py-4">
            <CopyInput value={`https://neoai.khulnasoft.com${pathname}`} />
            <Button
