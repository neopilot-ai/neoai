      ...
      <div className="mb-40">
        ...
        <div className="flex items-center flex-col text-center relative">
          <p className="text-lg mt-4 max-w-[600px]">
            No need to rebuild from scratch. Use Neoai's solid foundation and
      ...
      <div className="flex items-center flex-col text-center relative mt-28 mb-24">
        <div className="max-w-[600px]">
          ...
          <p className="text-[#878787] text-sm">
            Unlock the power of Neoai's proven functionality to fuel your SaaS
          ...
          <div className="space-y-16 mt-12">
            <div>
              ...
              <p className="text-[#878787] text-sm text-left">
                ...
                Neoai provides a fully-integrated platform out of the box,
            ...
            <div>
              ...
              <p className="text-[#878787] text-sm text-left">
                Neoai's open-source repository acts as a powerful starting point
                for your SaaS. You get full access to our core functionality,
                which you can easily customize and expand as your business
                grows. Whether you need to add new features or integrate with
                third-party services, the flexibility of our codebase ensures
                your platform can evolve to meet your unique requirements
                without the need for a complete rebuild. This scalability allows
                you to seamlessly grow your SaaS as your user base and needs
                increase.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[#878787] text-sm text-left">
                Neoai is already trusted by leading SaaS companies to handle
                ...
                reliable. By leveraging Neoai, you're not only tapping into
