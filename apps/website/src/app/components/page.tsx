...
import { Card } from "@neoai/ui/card";
      ...
      <div className="mb-40 flex flex-col items-center">
        ...
        <div className="flex items-center flex-col text-center relative">
          <p className="text-lg mt-4 max-w-[600px]">
            A collection of open-source components based on Neoai features.
          </p>
        </div>

        <a href="https://git.new/neoai" target="_blank" rel="noreferrer">
