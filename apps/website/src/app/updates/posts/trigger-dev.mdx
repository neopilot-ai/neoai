...
summary: "At Neoai, we use background jobs extensively. Here's an in-depth exploration of our approach."
image: "/images/trigger.png"
tag: "Engineering"
---

At Neoai, we use background jobs extensively. Here's an in-depth exploration of our approach.
...
You can find all of our jobs in our [GitHub repository](https://github.com/neoai-ai/neoai/tree/main/packages/jobs/src).
