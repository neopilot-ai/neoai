...
summary: "The core of Neoai is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more."
image: "/images/engine.png"
tag: "Updates"
---

The core of Neoai is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more.
...
We provide an API that gives our services transformed transactions, accounts, and balances for Neoai to use. Here is how we built it and the technologies we chose.
...
If you are interested, feel free to sign up [here](https://neoai.khulnasoft.com/engine) for more information.

<br />
Neoai is fully open source. Feel free to check out our code [here](https://git.new/neoai).
