...
summary: "Neoai is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions"
image: "/images/novu.png"
tag: "Engineering"
---

Neoai is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions, and access general information how your business actually are doing. And that includes well-timed notifications via emails and push notifications, carefully curated for your convenience.
...
We started with created our own package `@neoai/notifications` where
...
And using our [New Transactions email](https://email.neoai.khulnasoft.com/preview/transactions) as an example, which is sent from a background job using Trigger.dev when you have new transactions.

```typescript
import { Notifications, Types, Events } from "@neoai/notifications";
...
<br />
![Neoai - In App Notifications](/images/notification-center.gif)
<br />
Thanks to the SDK `@novu/headless` we implemented the notification center for Neoai
...
<br />
![Neoai - In App Notifications](/images/notification-settings.gif)

<br />
### The future of Neoai x Novu
...
While this is just a draft on how we are using Novu in production you can dig deeper into the codebase in our [repository](https://git.new/neoai).
