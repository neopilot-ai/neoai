      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            ...
            your relationship with the Neoai application (the "Service")
            operated by Neoai Labs AB ("us", "we", or "our").
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            or Neoai Labs AB cancels it. You may cancel your Subscription
            through your online account management page or by contacting Neoai
          ...
          <p className="leading-7 mt-8">
            If automatic billing fails, Neoai Labs AB will issue an invoice and
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB may modify Subscription fees at its sole discretion.
          ...
          <p className="leading-7 mt-8">
            ...
            granted at the sole discretion of Neoai Labs AB.
          </p>
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB does not verify the accuracy or suitability of any
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB is not a financial advisor, accountant, or tax
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB accepts no liability for any consequences, losses, or
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB relies on third-party services (e.g., banking APIs,
          ...
          <ul className="list-disc pl-6 mt-4">
            ...
            <li className="leading-7">
              Neoai Labs AB cannot guarantee the completeness, accuracy,
            ...
            <li className="leading-7">
              Neoai Labs AB shall not be liable for any loss, damage, or
          ...
          <p className="leading-7 mt-8">
            ...
            infringement, please email dmca@khulnasoft.com with:
          </p>
          <ul className="list-disc pl-6 mt-4">
            <li className="leading-7">
          ...
          <p className="leading-7 mt-8">
            ...
            Neoai Labs AB and its licensors.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            that are not controlled by Neoai Labs AB.
          </p>

          <p className="leading-7 mt-8">
            We assume no responsibility for third-party content, privacy
            policies, or practices. You agree that Neoai Labs AB shall not be
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB and its affiliates, directors, employees, and
          ...
          <p className="leading-7 mt-8">
            These Terms constitute the entire agreement between you and Neoai
          ...
          <p className="leading-7 mt-8">support@khulnasoft.com</p>
        </div>
      </div>
    </>
  );
