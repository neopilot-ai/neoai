      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB ("us", "we", or "our") operates the Neoai application
          ...
          <ul>
            <li>
              ...
              <p className="leading-7 mt-8">
                Service is the Neoai application operated by Neoai Labs AB
              </p>
            </li>
            <li>
              <p className="leading-7 mt-8">
          ...
          <p className="leading-7 mt-8">
            Neoai's use of information received from Google APIs will adhere to
          ...
          <p className="leading-7 mt-8">
            If you are from the European Economic Area (EEA), Neoai Labs AB
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB will retain your Personal Data only for as long as is
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB will also retain Usage Data for internal analysis
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB will take all the steps reasonably necessary to ensure
          ...
          <p className="leading-7 mt-8">
            If Neoai Labs AB is involved in a merger, acquisition or asset sale,
          ...
          <p className="leading-7 mt-8">
            Under certain circumstances, Neoai Labs AB may be required to
          ...
          <p className="leading-7 mt-8">
            Neoai Labs AB may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Neoai Labs AB
            </li>
            <li>
          ...
          <p className="leading-7 mt-8">
            ...
            certain data protection rights. Neoai Labs AB aims to take
          ...
          <ul>
            ...
            <li>
              <p className="leading-7 mt-8">
                ...
                the right to withdraw your consent at any time where Neoai Labs
          ...
          <ul>
            <li>By email: support@khulnasoft.com</li>
          </ul>
        </div>
      </div>
    </>
