...
export const metadata: Metadata = {
  title: "Download",
  description:
    "With Neoai on Mac you have everything accessible just one click away.",
};
...
export default function Page() {
  return (
    <div className="container flex flex-col items-center mb-12 md:mb-48 text-center">
      ...
      <p className="mb-4 -mt-24 text-2xl	font-medium">Neoai for Mac</p>
      <p className="text-[#878787] font-sm max-w-[500px]">
        With Neoai on Mac you have everything <br />
