          ...
          <div>
            ...
            <Accordion type="single" collapsible className="w-full mt-10 mb-48">
              <AccordionItem value="item-1">
                <AccordionTrigger>
                  <span className="truncate">
                    Can I self-host neoai.khulnasoft.com?
                  </span>
                </AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger>
                  Can I run neoai.khulnasoft.com locally?
                </AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger>
                  Is neoai.khulnasoft.com open source?
                </AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent>
                  ...
                  cancel your subscription, you will still be able to use Neoai
              ...
              <AccordionItem value="item-6">
                <AccordionTrigger>
                  <span className="truncate max-w-[300px] md:max-w-full">
                    I have more questions about neoai.khulnasoft.com. How can I
                    get in touch?
                  </span>
                </AccordionTrigger>
                <AccordionContent>
                  ...
                  send us an email at{" "}
                  <a href="mailto:support@khulnasoft.com" className="underline">
