...
updateUrl='setpath(["updateUrl"]; "https://neoai.now.sh")'
...
nameShort='setpath(["nameShort"]; "NeoAI")'
nameLong='setpath(["nameLong"]; "NeoAI")'
linuxIconName='setpath(["linuxIconName"]; "neoai")'
applicationName='setpath(["applicationName"]; "codium")'
win32MutexName='setpath(["win32MutexName"]; "neoai")'
win32DirName='setpath(["win32DirName"]; "NeoAI")'
win32NameVersion='setpath(["win32NameVersion"]; "NeoAI")'
win32RegValueName='setpath(["win32RegValueName"]; "NeoAI")'
win32AppUserModelId='setpath(["win32AppUserModelId"]; "Microsoft.NeoAI")'
win32ShellNameShort='setpath(["win32ShellNameShort"]; "NeoAI")'
win32x64UserAppId='setpath (["win32x64UserAppId"]; "{{2E1F05D1-C245-4562-81EE-28188DB6FD17}")'
urlProtocol='setpath(["urlProtocol"]; "neoai")'
...
if [[ "$OS_NAME" == "linux" ]]; then
  ...
  # as we are renaming the application to neoai
